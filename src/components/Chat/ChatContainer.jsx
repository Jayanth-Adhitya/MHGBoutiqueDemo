  ...
  return (
    <div className="flex flex-col h-full max-w-3xl mx-auto overflow-x-hidden">
      ...
      <div className="p-3 pb-2 md:p-4 md:pb-3">
        ...
        {/* Input container */}
        <div className="flex items-center gap-2 p-1.5 md:p-2 rounded-2xl bg-white/5 border border-white/10 focus-within:border-[#11d452]/50 focus-within:bg-white/[0.07] transition-all duration-300">
          {/* Mic button */}
          <button
          ...
          <textarea
            ...
            className="
              ...
              disabled:opacity-50 py-2 px-1
              h-9 md:h-10 leading-tight
            "
            style={{ minHeight: 'unset', maxHeight: '80px' }}
          />
        ...
        <p className="hidden md:block text-[10px] text-gray-600 text-center mt-2">
